 ...
 /*
  *     Copyright (C) Sathish Kumar J vsat_in@yahoo.com., 2003-2004
  *
  *		Project:		
  *
  *		Module Name:	CHyperLink.cpp	
  *
  *     Abstract:		A hyperlink class.
  *
 ...
 VOID CHyperLink::PositionWindow()
 {
    ...
    // Move the window
    SetWindowPos(NULL, 
		WndRect.left, WndRect.top, WndRect.Width(), WndRect.Height(), SWP_NOZORDER);
 }
