# Microsoft Developer Studio Project File - Name="MainApp" - Package Owner=<4>
...
# ADD CPP /nologo /MD /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_AFXDLL" /FR /YX"StdAfx.h" /FD /c
...
# ADD LINK32 shlwapi.lib /nologo /subsystem:windows /machine:I386 /out:"Release/Win2fs.exe"
...
# ADD LINK32 shlwapi.lib /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"msvcrtd.lib mfc42d.lib" /out:"Debug/Win2fs.exe" /pdbtype:sept
# SUBTRACT LINK32 /nodefaultlib
...
# Name "MainApp - Win32 Release"
# Name "MainApp - Win32 Debug"
